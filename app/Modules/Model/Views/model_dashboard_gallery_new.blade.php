...
<div class="right_cont"> <!--all left-->
  <div class="user-header row"> <!--user header-->
    <div class="col-sm-12">
      ...
      @else
      <div class="l_i_name ">Add New Video Gallery</div>
      @endif
    ...
    <form role='form' method="post" name="newGalleryForm" class="form-horizontal" ng-submit="newGalleryForm.$valid && submitCreateGallery(newGalleryForm)" novalidate>
      <div class="form-group required">
        ...
        <div class="col-sm-9">
          ...
          <span ng-show="newGalleryForm.galleryName.$error.maxlength" class="label label-danger">Gallery name max length are 124 characters.</span>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 text-left"><button type="submit" id="submit" name="submit" class="btn btn-primary" ng-click="submitNewGallery(newGalleryForm)" ng-disabled="newGalleryForm.$submitted && submitted">Add Gallery</button></div>
      </div>
