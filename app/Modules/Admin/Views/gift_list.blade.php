	  ...
	  {!! Form::open(array('method'=>'post', 'role'=>'form', 'novalidate', 'files'=>true)) !!}
        <div class="box-body">
          ...
          <div class="form-group required">
            ...
            <input class="form-control" id="name"  autocomplete="off" name="name" placeholder="" type="text">
            <span class="text-red">{{$errors->first('name')}}</span>
          </div>
          <div class="form-group">
            <label for="file">Gift Image</label>
            <input class="form-control" id="file" autocomplete="off" name="file" placeholder="" type="file">
		   
          </div>
          <div class="form-group required">
              <label for="price" class="control-label">Price </label>
            <input class="form-control" id="price" autocomplete="off" name="price" type="number" placeholder="">
        ...
        <div class="box-footer text-center">
          ...
          <button type="submit" class="btn btn-danger btn-lg">Add Gift</button>
        </div>
      </form>
    </div>
  </div><!-- /.box -->
