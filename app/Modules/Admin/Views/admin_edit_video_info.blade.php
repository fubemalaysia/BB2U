...
@section('breadcrumb', '<li><a href="/admin/manager/media/video-gallery/'.$video->galleryId.'"><i class="fa fa-dashboard"></i> Videos</a></li><li class="active">Edit Video</li>')
@section('content')
        ...
        <form role='form' method="post" name="editVideoForm" class="form-horizontal" ng-submit="editVideoForm.$valid && submitUpdateVideo(editVideoForm)" novalidate>
          <div class="box-body">
            <div class="form-group required">
              <label class="control-label col-sm-3">Gallery </label>
              <div class="col-sm-9">
                ...
                <span class="label label-danger" ng-show="editVideoForm.$submitted && editVideoForm.videoGallery.$error.required">This field is required.</span>
